...
function LightsOutStart() {
  ...
  size = Math.floor((window_size_s <= h1_size) ? window_size_s : (window_size_s-h1_size)/5); /* Windowサイズに短い方を5(5x5のマトリクスを作りたいから)で割って、小数点以下を切り捨てた値を一つのブロックサイズとする */
...
//      div.addclass('loblock');                           /* cssのため、classを定義 */
